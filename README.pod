...
This will provide a F<t/author/critic-freenode.t> file for use during the
...
During these runs, F<t/author/critic-freenode.t> will use L<Test::Perl::Critic>
...
Original author of Dist-Zilla-Plugin-Test-Perl-Critic: Jerome Quelin
